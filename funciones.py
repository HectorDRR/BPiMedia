        ...
        if Modo == 4:
            ...
            if self.Temperatura < self.TMin:
                ...
                if self.Estado == 0:
                    ...
                    # En el caso de la placa, partiendo de 2 kW de resistencia y 200 l de depósito obtenemos unos 7 minutos. 1º = 4.180 Julios x kg = 4.180 * 200 kg = 836.000 J / 2.000 W = 418 seg.
                    grado = 418
...
def Placa(Quehacemos = 4, Tiempo = 0, Debug = False):
    ...
    if Quehacemos == 4:
        ...
        # En caso de que sea viernes o sábado, a última hora de la noche y ya nos hayamos bañado todos, 
