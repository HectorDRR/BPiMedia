...
declare -A lista
lista=([transmission-da]='sudo service transmission-daemon start' [amuled]='sudo service amule-daemon restart' [Botones.py]='sudo screen -d -m -S Botones -h 20000 /home/hector/bin/boton.sh' [vsftpd]='sudo service vsftpd start' [noip2]='sudo noip2' [minidlnad]='minidlnad')
