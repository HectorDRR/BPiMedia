...
declare -A lista
lista=([transmission-da]='sudo service transmission-daemon start' [amuled]='sudo service amule-daemon restart' [vsftpd]='sudo service vsftpd start' [minidlnad]='/usr/local/sbin/minidlnad')
